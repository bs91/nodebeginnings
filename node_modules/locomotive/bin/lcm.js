...
program.command('lcm')
  .description("  Locomotive command line client can be  used to create or start a server.")
  .option('-?, -h,  --help to show more help')
  .action(function(options) {
    console.log('lcm "%s" using %s mode', help, options.force);
  });
